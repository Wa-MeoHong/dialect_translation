...
def train(
    ...
    valid_data_path: str = "yahma/alpaca-cleaned",
    ...
    if val_set_size > 0:
        ...
        #)
        train_data = (
            dataset['train'].shuffle().map(generate_and_tokenize_prompt)            # modified code
        )
        val_data = (
            dataset['valid'].shuffle().map(generate_and_tokenize_prompt)            # modified code
        )
    else:
        train_data = dataset['train'].shuffle().map(generate_and_tokenize_prompt)   # modified code
        val_data = None
